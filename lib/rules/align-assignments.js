...
module.exports = {
  ...
  create(context) {
    ...
    return {
      VariableDeclaration:                          collectNodeGroups,
      'ExpressionStatement': collectNodeGroups,
      'Program:exit':                               checkAll
    };

    function collectNodeGroups(node) {
    ...
    function areAligned(maxPos, lines) {
      console.log('->', lines.filter(assignmentOnFirstLine));
      return lines
